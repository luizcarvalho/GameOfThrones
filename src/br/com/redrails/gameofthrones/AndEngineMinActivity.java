 ...
 */
public class AndEngineMinActivity extends BaseGame {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	public void onLoadResources() {
		...
		try {
			//this.mExplosionSound = SoundFactory.createSoundFromAsset(this.mEngine.getSoundManager(), this, "game_of_thrones_loop.ogg");
			this.soundTrack = SoundFactory.createSoundFromAsset(this.mEngine.getSoundManager(), this, "track.ogg");
	...
	public Scene onLoadScene() {
		...
		AndEngineMinActivity.this.soundTrack.setLooping(true);
		...
		final Path path = new Path(5).to(293, 600).to(293, 160).to(293, 162).to(293,150).to(293, 600);
	...
	public void onLoadComplete() {
		AndEngineMinActivity.this.soundTrack.play();
	}
